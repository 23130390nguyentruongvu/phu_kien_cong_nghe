    ...
    <div class="content-register">
        <div class="container">
            <div class="form-register">
                ...
                <form class="register" id="registrationForm" action="${pageContext.request.contextPath}/register"
                      method="post">
                    ...
                    <input type="password" name="confirm_password" required="required" placeholder="Nhập lại mật khẩu"
                           id="password2">
