...
<main id="main" class="main">
    <div class="main-container">
        ...
        <div class="add-address-content">
            <div class="container">
                <div class="title"><h3>Cập nhật địa chỉ</h3></div>
                <form class="form-address" id="form-address" method="post" action="${pageContext.request.contextPath}/update-address">
                    <input type="hidden" name="addressId" value="${address.id}">
                    <div class="form-main">
                        <div class="name">
                            <input type="text" name="receiverName" class="input-name" value="${address.receiverName}" placeholder="&nbsp;Họ và tên">
                        </div>
                        <div class="phone">
                            <input type="tel" name="phone" class="input-phone" value="${address.phoneNumber}" placeholder="&nbsp;Số điện thoại">
                        </div>
                        ...
                        <div class="address-detail">
                            <input class="input-address-details" name="addressDetail"  value="${address.addressDetail}" type="text" placeholder="&nbsp;Địa chỉ chi tiết">
                        </div>
