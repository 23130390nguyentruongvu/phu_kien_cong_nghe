...
<head>
    ...
    <link rel="stylesheet" href="css/term_of_service.css">
...
<main id="main" class="main-container">
        ...
        <aside id="nav_menu-9" class="widget widget_nav_menu">
            <nav class="menu-danh-muc-trang-container" aria-label="Menu">
                <ul id="menu-danh-muc-trang" class="menu">
                    ...
                    <li><a href="term_of_service.html">Điều Khoản Dịch Vụ</a></li>
                </ul>
            </nav>
        </aside>
    </div>
    <div class="entry-content">
        ...
        <p>Chào mừng quý khách đến với website: phukiencongnghe, vui lòng đọc kỹ Điều Khoản Dịch Vụ.</p>
        ...
        <p>– Và khi quý khách tiếp tục sử dụng trang web, sau khi các thay đổi về Điều Khoản Dịch Vụ này được đăng tải, có nghĩa là quý khách chấp nhận với những thay đổi đó. Quý khách vui lòng kiểm tra thường xuyên để cập nhật những thay đổi của chúng tôi.</p>
        ...
        <p>
            – Chúng tôi sẽ cấp một tài khoản (Account) sử dụng để khách hàng có thể mua sắm trên website Phụ Kiện Công Nghệ trong khuôn khổ Điều khoản và Điều kiện sử dụng đã đề ra.
        </p>
        <p>
            – Quý khách hàng sẽ phải đăng ký tài khoản với thông tin xác thực về bản thân và phải cập nhật nếu có thay đổi nào. Mỗi người truy cập phải có trách nhiệm với mật khẩu, tài khoản và hoạt động của mình trên web. Hơn nữa, quý khách phải thông báo cho chúng tôi biết khi tài khoản bị truy cập trái phép. Chúng tôi không chịu bất kỳ trách nhiệm nào, dù trực tiếp hay gián tiếp, đối với những thiệt hại hoặc mất mát gây ra do quý khách không tuân thủ quy định.
        </p>
        <p>
        ...
        <p>
            – Trong suốt quá trình đăng ký, quý khách đồng ý nhận email thông báo từ website. Nếu không muốn tiếp tục nhận mail, quý khách có thể từ chối bằng cách thực hiện theo hướng dẫn của chúng tôi trong mỗi email.
        </p>
        <ol start="2">
            <li>Ý kiên của khách hàng</li>
        </ol>
        <p>–  Điều Khoản Dịch Vụ quy định tất cả nội dung trang web và ý kiến phê bình của quý khách đều là tài sản của chúng tôi. Nếu chúng tôi phát hiện bất kỳ thông tin giả mạo nào, chúng tôi sẽ khóa tài khoản của quý khách ngay lập tức hoặc áp dụng các biện pháp khác theo quy định của pháp luật Việt Nam.</p>
        <ol start="3">
            <li>Xác nhận và từ chối đơn hàng</li>
        </ol>
        <p>
            – Khi quý khách đặt hàng tại Phụ Kiện Công Nghệ, chúng tôi sẽ nhận được yêu cầu đặt hàng và gửi đến quý khách mã số đơn hàng. Tuy nhiên, yêu cầu đặt hàng cần thông qua một bước xác nhận đơn hàng, Shop chỉ xác nhận đơn hàng nếu yêu cầu đặt hàng của quý khách thỏa mãn các tiêu chí thực hiện đơn hàng tại website.
        </p>
        <p>
        ...
        <p>
            – Chúng tôi có quyền từ chối hoặc hủy đơn hàng của quý khách vì bất kỳ lý do gì liên quan đến lỗi kỹ thuật, hệ thống một cách khách quan vào bất kỳ lúc nào. Chúng tôi sẽ hỏi thêm về số điện thoại và địa chỉ nhận hàng trước khi xác nhận đơn hàng.
        </p>
        <ol start="4">
            <li>Hủy bỏ đơn hàng tại Phụ Kiện Công Nghệ</li>
        </ol>
        <p>– Trường hợp quý khách muốn hủy bỏ đơn hàng đã thực hiện trên website phukiencongnghe xin vui lòng liên hệ số Hotline để yêu cầu hủy đơn hàng hoặc từ chối nhận hàng trong trường hợp đơn hàng của bạn đang được vận chuyển.</p>
        <ol start="5">
            <li>Phiếu giảm giá và Mã giảm giá</li>
        </ol>
        <p>– Phiếu giảm giá/ Mã giảm giá là hình thức chiết khấu mà Phụ Kiện Công Nghệ dành cho khách hàng có thể có giá trị giảm một phần hoặc toàn phần giá trị của đơn hàng.</p>
        <p>– Mỗi đơn hàng chỉ có thể áp dụng 1 mã giảm giá, quý khách sẽ nhận được thông tin chi tiết về điều khoản và điều kiện sử dụng mã giảm giá kèm theo.</p>
        <p>– Shop có quyền từ chối các đơn hàng sử dụng mã giảm giá không thỏa mãn điều khoản và điều kiện sử dụng mã giảm giá mà không cần thông báo trước. Mã giảm giá trong trường hợp này sẽ không được cấp lại. Ngoài ra, phukiencongnghe có quyền từ chối việc gia hạn mã đã hết hạn sử dụng, mã không được sử dụng hết giá trị hoặc các trường hợp đơn phương ngừng thực hiện đơn hàng phát sinh từ phía quý khách.</p>
        <ol start="6">
            <li>Điều kiện và Điều khoản sử dụng Phiếu Giảm Giá và Mã Giảm Giá</li>
        </ol>
        <p>– Các Phiếu giảm giá, Mã giảm giá sẽ được áp dụng cho đơn hàng có đủ điều kiện và tùy theo quy định của từng chương trình khuyến mãi cụ thể. Thông tin chi tiết về điều kiện và điều khoản sử dụng Phiếu giảm giá, Mã giảm giá và các Chương trình khuyến mãi Quý khách vui lòng truy cập website tại từng thời điểm cụ thể của mỗi chương trình.</p>
        <ol start="7">
            <li>Thanh toán an toàn và tiện lợi tại Phụ Kiện Công Nghệ</li>
        </ol>
        <p>
            – Người mua có thể tham khảo và lựa chọn các phương thức thanh toán phù hợp sau đây:
        </p>
        <p>
            + Cách 1: Thanh toán khi nhận hàng (COD – giao hàng và thu tiền tận nơi).
        </p>
        <p>
            + Cách 2: Thanh toán chuyển khoản Ngân hàng trực tiếp.
        </p>
        <p>
            – Đối với người mua hàng từ Phụ Kiện Công Nghệ thì phải tuân thủ theo chính sách thanh toán của shop.
        </p>
        <ol start="8">
            <li>Giải quyết hậu quả do lỗi nhập sai thông tin tại Phụ Kiện Công Nghệ</li>
        </ol>
        <p>– Khách hàng có trách nhiệm cung cấp thông tin đầy đủ và chính xác khi tham gia giao dịch tại Phụ Kiện Công Nghệ. Trong trường hợp khách hàng nhập sai thông tin, Phụ Kiện Công Nghệ có quyền từ chối thực hiện giao dịch.</p>
        <p>– Trong trường hợp sai thông tin phát sinh từ phía website mà Phụ Kiện Công Nghệ có thể chứng minh đó là lỗi của hệ thống, shop sẽ giải quyết các sự cố phát sinh cho khách hàng hoặc sẽ đền bù một mã giảm giá cho các lần mua hàng tiếp theo với mệnh giá tùy từng trường hợp cụ thể và có quyền không thực hiện giao dịch bị lỗi.</p>
        ...
        <p>– Các điều kiện, điều khoản và nội dung của trang web này được điều chỉnh theo luật pháp Việt Nam, Tòa án có thẩm quyền tại Việt Nam sẽ giải quyết bất kỳ tranh chấp nào phát sinh từ việc sử dụng trái phép trang web này.</p>
        <ol start="11">
            <li>Giải quyết tranh chấp</li>
        </ol>
        <p>– Bất kỳ tranh cãi, khiếu nại hoặc tranh chấp phát sinh từ hoặc liên quan đến giao dịch tại Phụ Kiện Công Nghệ hoặc các Quy định và Điều Khoản Dịch Vụ này đều sẽ được giải quyết bằng hình thức thương lượng, hòa giải, trọng tài và/hoặc Tòa án theo Luật bảo vệ Người tiêu dùng Chương 4 về Giải quyết tranh chấp giữa người tiêu dùng và tổ chức, cá nhân kinh doanh hàng hóa, dịch vụ.</p>
        <p>Điều Khoản Dịch Vụ – giao dịch trên website Phukiencongnghe</p>
            ...
            <div class="footer-grid center">
                ...
                <div class="footer-column second nav">
                    <ul>
                        ...
                        <li><a href="term_of_service.html" class="text-hover"><i class="fa-solid fa-pen-nib"></i> Điều khoản dịch vụ</a>
                        </li>
