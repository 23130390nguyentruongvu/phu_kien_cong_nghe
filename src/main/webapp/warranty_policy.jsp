...
<head>
    ...
    <link rel="stylesheet" href="css/warranty_policy.css">
                    ...
                    <aside id="nav_menu-9" class="widget widget_nav_menu">
                        <nav class="menu-danh-muc-trang-container" aria-label="Menu">
                            <ul id="menu-danh-muc-trang" class="menu">
                                ...
                                <li><a href="warranty_policy.html">Chính Sách Bảo Hành</a></li>
            ...
            <div class="main-contain content-warranty-policy">
                ...
                <ol>
                    ...
                    <li>
                        ...
                        <br>
                        <p>- Thời gian đổi trả sẽ khác nhau tùy theo khu vực. Đối với khu vực gần TP.HCM sẽ rơi vào 2 đến 3 ngày, các tỉnh thành khác sẽ trong vòng 5 đến 6 ngày</p>
                        <p>- Địa chỉ đổi trả:
                             Kios 8 giang, phường Linh Trung, Thủ Đức. Số điện thoại 0793189034, Phụ Kiện Công Nghệ Shop
                        </p>
                    </li>
                ...
                <div class="footer-grid center">
                    ...
                    <div class="footer-column second nav">
                        <ul>
                            ...
                            <li><a href="warranty_policy.html" class="text-hover"><i class="fa-solid fa-award"></i> Chính sách bảo hành</a>
                            </li>
